...
export default function StockTakeDetailNotFound() {
  return (
    <div className="flex flex-col items-center justify-center gap-5 py-24">
      ...
      <div className="text-center space-y-1">
        <p className="font-heading font-bold text-sm uppercase tracking-wider">Stock take not found</p>
        <p className="text-sm font-sans text-muted-foreground">
          This stock take doesn&apos;t exist or has been removed.
        </p>
      </div>
      <Link
        href="../"
